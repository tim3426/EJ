USE [EJDEVO]
GO
/****** Object:  StoredProcedure [dbo].[USP_DATALIST_ADHOCQUERY_1E0AA3DE_98C4_4DF0_9328_1742BBBB026A]    Script Date: 10-Jul-19 2:48:53 PM ******/
SET ANSI_NULLS ON
GO
...
left outer join (
		select
		top 1 OrgPositions.CONSTITUENTID as [CONSTITUENTID],
		...
		left outer join (
			select ORGANIZATIONPOSITIONHOLDER.POSITIONID, ORGANIZATIONPOSITIONHOLDER.CONSTITUENTID
