...
from EJ_CONSTITUENT_HISTORY as C
	...
	**/
	...
	left join 
			...
			,ROW_NUMBER() OVER (PARTITION BY V_QUERY_INTERACTIONALL.CONSTITUENTID ORDER BY EXPECTEDDATE ASC) as ROWNUMBER
			FROM V_QUERY_INTERACTIONALL
			inner join EJ_CONSTITUENT_HISTORY on V_QUERY_INTERACTIONALL.OWNERID = EJ_CONSTITUENT_HISTORY.CONSTITUENTID
